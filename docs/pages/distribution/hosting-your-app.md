...
If you are loading in your update into a development app by passing in a URL string, you will need to pass in an URL pointing to your JSON manifest file.
